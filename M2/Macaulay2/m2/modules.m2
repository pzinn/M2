...
texMath Module := x -> if x.?texMath then x.texMath else if x.?relations or x.?generators then texMath expression x else if numgens x === 0 then "0" else texMath new Power from {ring x, numgens x}
