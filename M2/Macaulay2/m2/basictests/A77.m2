...
r = assert( {11,21,12,22} === for i in {1,2}, j in {10,20} list i+j )
assert(null === r)
r = assert( {11,12,22,23} === for i in {1,2}, j from i to i+1 list 10*i+j )
assert(null === r)
r = assert( {11,12,21,22} === for i in {1,2}, j from 1 to 3 when j < 3 list 10*i+j )
assert(null === r)
r = assert( {12,21} === for i in {1,2}, j in {1,2} list if i === j then continue else 10*i+j )
assert(null === r)
r = assert( {11} === for i in {1,2}, j in {10,20} list if i+j > 12 then break else i+j )
assert(null === r)
r = assert( 44 === for i in {1,2}, j in {10,20} do break 44 )
assert(null === r)
