...
redefs := hashTable apply({acos, agm, asin, atan, atan2, BesselJ, BesselY, cos, cosh, cot, coth, csc, csch, Digamma, eint, erf, erfc, exp, expm1, Gamma, log, log1p, sec, sech, sin, sinh, sqrt, tan, tanh, zeta},
    f -> f => method());
