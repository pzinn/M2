...
gfxRange1 GfxText := g -> (
    ...
    { p - vector {0,f}, p + vector{f*0.6*length g.GfxString,0} } -- very approximate
    )

--GfxLine = new GfxType from ("line", { GfxPoint1 => vector {0,0}, GfxPoint2 => vector {50,50} })
--gfxRange1 GfxLine := g -> {} -- todo
-- useless
